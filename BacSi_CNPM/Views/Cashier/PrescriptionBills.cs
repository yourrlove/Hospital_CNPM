...
namespace Hospital.Views.Cashier
{
    public partial class PrescriptionBills : Form
    {
        ...
        {
            // curr.DT_ID = DT_ID;
            lb_prescriptionName.Text = cashier.TenDon(DT_ID).ToUpper();
            try
            {
        ...
        {
            bill_name.Text = "BILL " + cashier.TenDon(DT_ID).ToUpper();
            try
            {
        ...
        private void successNotification()
        {
            ...
            success.ContentText = "Payment Successfully!";
        ...
        private void warningNotification()
        {
            ...
            warning.Image = (Image)Properties.Resources.ResourceManager.GetObject("warningcolor");
            warning.BodyColor = Color.Yellow;
            warning.TitleText = "Warning!";
            warning.TitleColor = Color.Black;
            warning.TitleFont = new Font("Century Gothic", 15, FontStyle.Bold);

            warning.ContentText = "Please choose a payment method!";
            warning.ContentColor = Color.Black;
            warning.ContentFont = new Font("Century Gothic", 12, FontStyle.Regular);
            warning.Popup();
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString($"Thu Ngan: {cashier.TN_ID}", normalFont, Brushes.Black, new Point(leftMargin, centerY + 250));
