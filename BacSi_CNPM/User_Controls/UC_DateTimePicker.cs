...
namespace BacSi_CNPM.User_Controls
{
    public partial class UC_DateTimePicker : DateTimePicker
    {
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.calendarcolor ;
        ...
        public UC_DateTimePicker()
        {
            ...
            this.Font = new Font(this.Font.Name, 9.0F);
        }

        private void UC_DateTimePicker_Load(object sender, EventArgs e)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                // Resize the calendar icon to 17x17
                Image resizedIcon = ResizeImage(calendarIcon, 17, 17);
                // Draw the resized icon
                graphics.DrawImage(resizedIcon, this.Width - resizedIcon.Width - 9, (this.Height - resizedIcon.Height) / 2);
                resizedIcon.Dispose();
            }
        }
